import { parseConfig, appendAudit, verifyCredential, enforceMandate, CrossRailLedger, assertLedgerCoreSafe } from '@observer-protocol/policy-engine';
...
export function createObserverCondition(cfg: ObserverWdkConfig): ObserverConditionPair {
  // Self-report the bundled core (frozen in this dist at build); warn if below the
  // ledger-safe floor, or refuse via cfg.refuseUnsafeCore. Silent when safe.
