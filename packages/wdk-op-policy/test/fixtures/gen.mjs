...
import { OUT, ISSUER, AGENT, SCHEMA_URL, SCHEMA_URL_V22, SCHEMA_URL_V24, MERCHANT_ADDR, TRON_MERCHANT } from './consts.mjs';
...
const creds = {
  ...
  // v2.4: same valid USDC mandate, declaring the current Sovereign delegation
  // schema — proves the v2.4 the allowlist accepts is verified end-to-end.
  'wdk-usdc-v24': sign(baseCredential({ top: { credentialSchema: { id: SCHEMA_URL_V24, type: 'JsonSchema' } } })),
